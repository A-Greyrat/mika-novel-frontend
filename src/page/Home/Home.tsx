                    ...
                    <div>
                        <CarouselList items={[
                            <CarouselNovelCard title="关于我转生变成史莱姆这档事"
                                               ...
                                               tags={["异世界", "奇幻", "战斗"]} url='/' imgWidth={200}
                                               imgHeight={300}/>,
                            <CarouselNovelCard title="Title 2" cover="https://via.placeholder.com/100" author="伏瀬"
                                               description="Description 2" tags={["tag1", "tag2"]} url='/'
                                               imgWidth={200}
                                               imgHeight={300}/>,
                            <CarouselNovelCard title="Title 3" cover="https://via.placeholder.com/100" author="伏瀬"
                                               description="Description 3" tags={["tag1", "tag2"]} url='/'
                                               imgWidth={200}
                                               imgHeight={300}/>,
                            <CarouselNovelCard title="Title 4" cover="https://via.placeholder.com/100" author="伏瀬"
